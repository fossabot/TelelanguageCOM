	...
	vc_map(array(
		...
		"params" => array(
			...
			array(
				...
				"param_name" => "list",
				"value" => array('Select'=>'','Default'=>'list-default','Number'=>'list-number','Square'=>'list-square','Number 2'=>'list-number-background','List Arrow'=>'list-arrow','List Circle'=>'list-circle','List Star'=>'list-star'),
				),				
