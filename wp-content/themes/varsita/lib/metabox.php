...
function thm_register_meta_boxes( $meta_boxes )
{
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name'     => __( 'Select Sidebar', 'themeum' ),
				'id'       => "{$prefix}slidebar",
				'type'     => 'select',
				// Array of 'value' => 'Label' pairs for select box
				'options'  => array(
					'1' => __( 'Default Sidebar', 'themeum' ),
					'2' => __( 'Event Slidebar', 'themeum' ),
					'3' => __( 'Course Slidebar', 'themeum' ),
	...
	$meta_boxes[] = array(
		...
		// Meta box title - Will appear at the drag and drop handle bar. Required.
		'title' => __( 'Post tttt Settings', 'themeum' ),
		...
		'fields' => array(
			array(
				// Field name - Will be used as label
				'name'  => __( 'Qoutesss Author', 'themeum' ),
				// Field ID, i.e. the meta key
				'id'    => "{$prefix}qoute_author",
				'desc'  => __( 'Write Qoute Author or Source', 'themeum' ),
				'type'  => 'text',
