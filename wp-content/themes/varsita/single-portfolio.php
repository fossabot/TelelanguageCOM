                    ...
                    <div class="portfolio-details">
                        ...
                        <div class="list list-star">
                            <ul>
                                ...
                                <li><strong><?php _e('Project Name : ','themeum'); ?></strong><?php echo esc_html($portfolio_client); ?></li>
                                <?php } ?>                          

                                <?php if($portfolio_date != ''){?>
                                <li><strong><?php _e('Date : ','themeum'); ?></strong><?php echo esc_html($portfolio_date); ?></li>
                                <?php } ?>                        

                                <?php if($portfolio_url != ''){?>
                                <li><strong><?php _e('Category : ' ,'themeum'); ?></strong><?php echo esc_html($term_name); ?></li>
                                <?php } ?>
                            </ul>
                        </div>
                             
                        <?php if($portfolio_url != ''){?>
                         <a href="<?php echo esc_url($portfolio_url); ?>" target="_blank" class="btn btn-common btn-previw"><?php _e('Preview','themeum'); ?> <i class="fa fa-long-arrow-right"></i></a>
                         <?php } ?>  
                    </div>  
                </div>
            </div>
