	...
	<ul id="group-list" class="invites item-list" role="main">
		...
		<?php while ( bp_groups() ) : bp_the_group(); ?>
			...
			<li>
				...
				<div class="action">
					<a class="button accept" href="<?php bp_group_accept_invite_link(); ?>"><?php _e( 'Accept', 'themeum' ); ?></a> &nbsp;
					<a class="button reject confirm" href="<?php bp_group_reject_invite_link(); ?>"><?php _e( 'Reject', 'themeum' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="info" role="main">
		<p><?php _e( 'You have no outstanding group invites.', 'themeum' ); ?></p>
	</div>
