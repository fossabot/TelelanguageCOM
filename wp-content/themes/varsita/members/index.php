								...
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<div class="item-list-tabs group-all" role="navigation">
											<ul>
												 <li class="selected" id="members-all"><a href="<?php bp_members_directory_permalink(); ?>"><i class="fa fa-group"></i> <?php printf( __( 'All Members <span>%s</span>', 'buddypress' ), bp_get_total_member_count() ); ?></a></li>
