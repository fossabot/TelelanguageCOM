    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'subtitle' => __('Use your Custom logo text Ex. Varsita', 'themeum'),
                        'default'   => 'Varsita',
                    ...
                    array( 
                        ...
                        'title'      => 'Coming Soon Page Logo',
                        'subtitle' => __('Upload Coming Soon Page Logo', 'themeum'),
                        'default' => array( 'url' => get_template_directory_uri() .'/images/comingsoon-logo.png' ), 
                    ),                     

                    array( 
                        'id'        => 'loginlogo', 
                        'type'      => 'media',
                        'desc'      => 'upload Login Page Logo',
                        'title'      => 'Login Page Logo',
                        'subtitle' => __('Upload Login Page Logo', 'themeum'),
                        'default' => array( 'url' => get_template_directory_uri() .'/images/logo.png' ), 
                    ),                     
                    ...
                    array( 
                        'id'        => 'registerlogo', 
                        'type'      => 'media',
                        'desc'      => 'upload Registration Page Logo',
                        'title'      => 'Registration Page Logo',
                        'subtitle' => __('Upload Registration Page Logo', 'themeum'),
                        'default' => array( 'url' => get_template_directory_uri() .'/images/logo.png' ), 
                    ), 
            ...
            ***********************************/
                   ...
                   array(
                    ...
                    array(
                     ...
                     array(
                        ...
                        'subtitle'  => __('Pick a link color (default: #998675).', 'themeum'),
                        'default'   => '#998675',
                        'validate'  => 'color',
                        'transparent'   =>false,
                     ...
                     array(
                        ...
                        'subtitle'  => __('Pick a hover color (default: #77695b).', 'themeum'),
                        'default'   => '#77695b',
                        'validate'  => 'color',
                        'transparent'   =>false,
                        'required'  => array('custom-preset-en', "=", 1),
                    ...
                    array(
                        'id'        => 'bottom-bg',
                        'type'      => 'color',
                        'title'     => __('Bottom Background Color', 'themeum'),
                        'subtitle'  => __('Pick Color for Bottom Background ( default: #fafafa )', 'themeum'),
                        'default'   => '#fafafa',
                        'validate'  => 'color',
                        'transparent'   =>false,
                    ),                     
            ...
            /* *********************************
            **** Dynamic Slyder Field  *****
            ********************************** */
            $this->sections[] = array(
                'title'     => __('Tiny Slider', 'themeum'),
                'icon'      => 'sub-header-icon',
                'icon_class' => 'el-icon-cogs',
                'fields'    => array(
                     array(
                        'id'          => 'opt-slides',
                        'type'        => 'slides',
                        'title'       => __('Slider Options', 'themeum'),
                        'subtitle'    => __('Add Slider From Here.', 'themeum'),
                        )
                    ));


            /* *********************************
            **** Certifigate Setting Field  *****
            ********************************** */
            $this->sections[] = array(
                'title'     => __('Certifigate Setting', 'themeum'),
                'icon'      => 'sub-header-icon',
                'icon_class' => 'el-icon-flag',
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'full-name',
                        'type'      => 'switch',
                        'title'     => __('Full Name', 'themeum'),
                        'subtitle'  => __('Enable or disable Full Name from Certifigate', 'themeum'),
                        'default'   => true,
                    ),
                    array(
                        'id'        => 'user-image',
                        'type'      => 'switch',
                        'title'     => __('Student Image', 'themeum'),
                        'subtitle'  => __('Enable or disable Student Image from Certifigate', 'themeum'),
                        'default'   => true,
                    ),
                    array(
                        'id'        => 'certificate-bg-color',
                        'type'      => 'color',
                        'title'     => __('Certificate Background Color', 'themeum'),
                        'subtitle'  => __('Pick Color for Certificate Background ( default: #998675 )', 'themeum'),
                        'default'   => '#998675',
                        'validate'  => 'color',
                        'transparent'   =>false,
                    ),
                    array(
                        'id'        => 'course-type',
                        'type'      => 'switch',
                        'title'     => __('Course Type', 'themeum'),
                        'subtitle'  => __('Enable or disable Course Type from Certifigate', 'themeum'),
                        'default'   => true,
                    ),
                    array(
                        'id'        => 'course-name',
                        'type'      => 'switch',
                        'title'     => __('Course Name', 'themeum'),
                        'subtitle'  => __('Enable or disable Course Name from Certifigate', 'themeum'),
                        'default'   => true,
                    ),
                    array(
                        'id'        => 'certifigate-logo', 
                        'type'      => 'media',
                        'desc'      => 'Upload Certifigate Logo',
                        'title'      => __('Certifigate Logo','themeum'),
                        'subtitle' => __('Upload Certifigate Logo', 'themeum'),
                        'default' => array( 'url' => get_template_directory_uri() .'/images/logo-cretificate.png' ),
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    array(
                        'id'        => 'folio-per-page',
                        'type'      => 'text',
                        'title'     => __('Portfolio Per Page', 'themeum'),
                        'default'   => '12',
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'default'   => __('<div>Copyright © 2014 Varsita Demo. Designed by <a href="http://wwww.themeum.com/" target="_blank">Themeum</a></div>', 'themeum'),
